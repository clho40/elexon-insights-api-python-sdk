...
class InsightsApiModelsResponsesResponseWithMetadata1InsightsApiModelsResponsesForecastSurplusForecastSurplusWeekly(BaseModel):
    """
    InsightsApiModelsResponsesResponseWithMetadata1InsightsApiModelsResponsesForecastSurplusForecastSurplusWeekly
    """
    data: Optional[conlist(InsightsApiModelsResponsesForecastSurplusForecastSurplusWeekly)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesResponseWithMetadata1InsightsApiModelsResponsesForecastSurplusForecastSurplusWeekly:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesResponseWithMetadata1InsightsApiModelsResponsesForecastSurplusForecastSurplusWeekly:
        ...
        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesResponseWithMetadata1InsightsApiModelsResponsesForecastSurplusForecastSurplusWeekly.parse_obj(obj)

        _obj = InsightsApiModelsResponsesResponseWithMetadata1InsightsApiModelsResponsesForecastSurplusForecastSurplusWeekly.parse_obj({
            "data": [InsightsApiModelsResponsesForecastSurplusForecastSurplusWeekly.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
