...
class InsightsApiModelsResponsesDemandOutturnDatasetRowsDemandOutturnNational(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesDemandOutturnDatasetRowsDemandOutturnNational:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesDemandOutturnDatasetRowsDemandOutturnNational:
        """Create an instance of InsightsApiModelsResponsesDemandOutturnDatasetRowsDemandOutturnNational from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesDemandOutturnDatasetRowsDemandOutturnNational.parse_obj(obj)

        _obj = InsightsApiModelsResponsesDemandOutturnDatasetRowsDemandOutturnNational.parse_obj({
