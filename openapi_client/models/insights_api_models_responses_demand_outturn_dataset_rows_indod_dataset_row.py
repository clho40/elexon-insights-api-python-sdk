...
class InsightsApiModelsResponsesDemandOutturnDatasetRowsIndodDatasetRow(BaseModel):
    """
    ...
    __properties = ["dataset", "publishTime", "settlementDate", "demand"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesDemandOutturnDatasetRowsIndodDatasetRow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesDemandOutturnDatasetRowsIndodDatasetRow:
        """Create an instance of InsightsApiModelsResponsesDemandOutturnDatasetRowsIndodDatasetRow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesDemandOutturnDatasetRowsIndodDatasetRow.parse_obj(obj)

        _obj = InsightsApiModelsResponsesDemandOutturnDatasetRowsIndodDatasetRow.parse_obj({
