...
class InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryPeriodMaxData(BaseModel):
    """
    ...
    period_max: Optional[StrictInt] = Field(None, alias="periodMax")
    ...
    __properties = ["dataset", "settlementDate", "settlementPeriod", "time", "periodMax", "nationalGridBmUnit", "bmUnit"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryPeriodMaxData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryPeriodMaxData:
        """Create an instance of InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryPeriodMaxData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryPeriodMaxData.parse_obj(obj)

        _obj = InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryPeriodMaxData.parse_obj({
            "dataset": obj.get("dataset"),
            "settlement_date": obj.get("settlementDate"),
            "settlement_period": obj.get("settlementPeriod"),
            "time": obj.get("time"),
            "period_max": obj.get("periodMax"),
