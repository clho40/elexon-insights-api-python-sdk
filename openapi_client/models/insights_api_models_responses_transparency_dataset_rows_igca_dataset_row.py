...
class InsightsApiModelsResponsesTransparencyDatasetRowsIgcaDatasetRow(BaseModel):
    """
    ...
    __properties = ["dataset", "documentId", "documentRevisionNumber", "publishTime", "businessType", "psrType", "year", "quantity"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesTransparencyDatasetRowsIgcaDatasetRow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesTransparencyDatasetRowsIgcaDatasetRow:
        """Create an instance of InsightsApiModelsResponsesTransparencyDatasetRowsIgcaDatasetRow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesTransparencyDatasetRowsIgcaDatasetRow.parse_obj(obj)

        _obj = InsightsApiModelsResponsesTransparencyDatasetRowsIgcaDatasetRow.parse_obj({
