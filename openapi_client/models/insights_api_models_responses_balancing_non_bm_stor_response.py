...
class InsightsApiModelsResponsesBalancingNonBmStorResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesBalancingNonBmStorResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesBalancingNonBmStorResponse:
        """Create an instance of InsightsApiModelsResponsesBalancingNonBmStorResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesBalancingNonBmStorResponse.parse_obj(obj)

        _obj = InsightsApiModelsResponsesBalancingNonBmStorResponse.parse_obj({
