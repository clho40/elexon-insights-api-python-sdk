...
class InsightsApiModelsResponsesBalancingBalancingServicesVolume(BaseModel):
    """
    ...
    __properties = ["settlementDate", "settlementPeriod", "bmUnitApplicableBalancingServicesVolume", "nationalGridBmUnit", "bmUnit", "time"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesBalancingBalancingServicesVolume:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesBalancingBalancingServicesVolume:
        """Create an instance of InsightsApiModelsResponsesBalancingBalancingServicesVolume from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesBalancingBalancingServicesVolume.parse_obj(obj)

        _obj = InsightsApiModelsResponsesBalancingBalancingServicesVolume.parse_obj({
