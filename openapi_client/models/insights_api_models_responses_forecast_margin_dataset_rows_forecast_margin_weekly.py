...
class InsightsApiModelsResponsesForecastMarginDatasetRowsForecastMarginWeekly(BaseModel):
    """
    ...
    __properties = ["dataset", "publishTime", "week", "year", "margin"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesForecastMarginDatasetRowsForecastMarginWeekly:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesForecastMarginDatasetRowsForecastMarginWeekly:
        """Create an instance of InsightsApiModelsResponsesForecastMarginDatasetRowsForecastMarginWeekly from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesForecastMarginDatasetRowsForecastMarginWeekly.parse_obj(obj)

        _obj = InsightsApiModelsResponsesForecastMarginDatasetRowsForecastMarginWeekly.parse_obj({
