...
class InsightsApiModelsResponsesBalancingPhysicalDatasetRowsPhysicalNotificationData(BaseModel):
    """
    ...
    __properties = ["dataset", "settlementDate", "settlementPeriod", "timeFrom", "timeTo", "levelFrom", "levelTo", "nationalGridBmUnit", "bmUnit"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesBalancingPhysicalDatasetRowsPhysicalNotificationData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesBalancingPhysicalDatasetRowsPhysicalNotificationData:
        """Create an instance of InsightsApiModelsResponsesBalancingPhysicalDatasetRowsPhysicalNotificationData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesBalancingPhysicalDatasetRowsPhysicalNotificationData.parse_obj(obj)

        _obj = InsightsApiModelsResponsesBalancingPhysicalDatasetRowsPhysicalNotificationData.parse_obj({
