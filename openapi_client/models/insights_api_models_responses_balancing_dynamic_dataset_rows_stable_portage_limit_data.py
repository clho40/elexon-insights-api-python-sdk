...
class InsightsApiModelsResponsesBalancingDynamicDatasetRowsStablePortageLimitData(BaseModel):
    """
    ...
    __properties = ["dataset", "settlementDate", "settlementPeriod", "time", "level", "nationalGridBmUnit", "bmUnit"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesBalancingDynamicDatasetRowsStablePortageLimitData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesBalancingDynamicDatasetRowsStablePortageLimitData:
        """Create an instance of InsightsApiModelsResponsesBalancingDynamicDatasetRowsStablePortageLimitData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesBalancingDynamicDatasetRowsStablePortageLimitData.parse_obj(obj)

        _obj = InsightsApiModelsResponsesBalancingDynamicDatasetRowsStablePortageLimitData.parse_obj({
