...
class BidOfferApi:
    ...
    def balancing_bid_offer_all_get(self, settlement_date : Annotated[datetime, Field(..., description="The settlement date or datetime to filter.")], settlement_period : Annotated[Optional[StrictInt], Field(description="The settlement period to filter. This should be an integer from 1-50 inclusive.")] = None, bm_unit : Annotated[Optional[conlist(StrictStr)], Field(description="The BM Units to query. Elexon or NGC BMU IDs can be used. If omitted, results for all BM units will be returned.")] = None, format : Annotated[Optional[StrictStr], Field(description="Response data format. Use json/xml to include metadata.")] = None, **kwargs) -> InsightsApiModelsResponsesResponseWithMetadata1InsightsApiModelsResponsesBalancingBidOfferResponse:  # noqa: E501
        ...
        >>> thread = api.balancing_bid_offer_all_get(settlement_date, settlement_period, bm_unit, format, async_req=True)
        >>> result = thread.get()
        ...
        :rtype: InsightsApiModelsResponsesResponseWithMetadata1InsightsApiModelsResponsesBalancingBidOfferResponse
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the balancing_bid_offer_all_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.balancing_bid_offer_all_get_with_http_info(settlement_date, settlement_period, bm_unit, format, **kwargs)  # noqa: E501

    @validate_arguments
    def balancing_bid_offer_all_get_with_http_info(self, settlement_date : Annotated[datetime, Field(..., description="The settlement date or datetime to filter.")], settlement_period : Annotated[Optional[StrictInt], Field(description="The settlement period to filter. This should be an integer from 1-50 inclusive.")] = None, bm_unit : Annotated[Optional[conlist(StrictStr)], Field(description="The BM Units to query. Elexon or NGC BMU IDs can be used. If omitted, results for all BM units will be returned.")] = None, format : Annotated[Optional[StrictStr], Field(description="Response data format. Use json/xml to include metadata.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Bid-Offer Market-Wide Data  # noqa: E501
        ...
        >>> thread = api.balancing_bid_offer_all_get_with_http_info(settlement_date, settlement_period, bm_unit, format, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(InsightsApiModelsResponsesResponseWithMetadata1InsightsApiModelsResponsesBalancingBidOfferResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method balancing_bid_offer_all_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "InsightsApiModelsResponsesResponseWithMetadata1InsightsApiModelsResponsesBalancingBidOfferResponse",
            '400': None,
            '500': None,
        }
    ...
    def balancing_bid_offer_get(self, bm_unit : Annotated[StrictStr, Field(..., description="The BM Unit to query.")], var_from : Annotated[datetime, Field(..., description="The \"from\" start time or settlement date for the filter.")], to : Annotated[datetime, Field(..., description="The \"to\" start time or settlement date for the filter.")], settlement_period_from : Annotated[Optional[StrictInt], Field(description="The \"from\" settlement period for the filter. This should be an integer from 1-50 inclusive.")] = None, settlement_period_to : Annotated[Optional[StrictInt], Field(description="The \"to\" settlement period for the filter. This should be an integer from 1-50 inclusive.")] = None, format : Annotated[Optional[StrictStr], Field(description="Response data format. Use json/xml to include metadata.")] = None, **kwargs) -> InsightsApiModelsResponsesResponseWithMetadata1InsightsApiModelsResponsesBalancingBidOfferResponse:  # noqa: E501
        ...
        >>> thread = api.balancing_bid_offer_get(bm_unit, var_from, to, settlement_period_from, settlement_period_to, format, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the balancing_bid_offer_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.balancing_bid_offer_get_with_http_info(bm_unit, var_from, to, settlement_period_from, settlement_period_to, format, **kwargs)  # noqa: E501

    @validate_arguments
    def balancing_bid_offer_get_with_http_info(self, bm_unit : Annotated[StrictStr, Field(..., description="The BM Unit to query.")], var_from : Annotated[datetime, Field(..., description="The \"from\" start time or settlement date for the filter.")], to : Annotated[datetime, Field(..., description="The \"to\" start time or settlement date for the filter.")], settlement_period_from : Annotated[Optional[StrictInt], Field(description="The \"from\" settlement period for the filter. This should be an integer from 1-50 inclusive.")] = None, settlement_period_to : Annotated[Optional[StrictInt], Field(description="The \"to\" settlement period for the filter. This should be an integer from 1-50 inclusive.")] = None, format : Annotated[Optional[StrictStr], Field(description="Response data format. Use json/xml to include metadata.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Bid-Offer Data Per-BMU  # noqa: E501
        ...
        >>> thread = api.balancing_bid_offer_get_with_http_info(bm_unit, var_from, to, settlement_period_from, settlement_period_to, format, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method balancing_bid_offer_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
