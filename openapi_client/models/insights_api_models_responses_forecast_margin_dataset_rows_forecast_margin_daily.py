...
class InsightsApiModelsResponsesForecastMarginDatasetRowsForecastMarginDaily(BaseModel):
    """
    ...
    __properties = ["dataset", "publishTime", "forecastDate", "margin"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesForecastMarginDatasetRowsForecastMarginDaily:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesForecastMarginDatasetRowsForecastMarginDaily:
        """Create an instance of InsightsApiModelsResponsesForecastMarginDatasetRowsForecastMarginDaily from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesForecastMarginDatasetRowsForecastMarginDaily.parse_obj(obj)

        _obj = InsightsApiModelsResponsesForecastMarginDatasetRowsForecastMarginDaily.parse_obj({
