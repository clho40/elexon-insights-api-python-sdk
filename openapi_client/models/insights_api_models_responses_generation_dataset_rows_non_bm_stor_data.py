...
class InsightsApiModelsResponsesGenerationDatasetRowsNonBmStorData(BaseModel):
    """
    ...
    __properties = ["dataset", "publishTime", "startTime", "settlementDate", "settlementPeriod", "generation"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesGenerationDatasetRowsNonBmStorData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesGenerationDatasetRowsNonBmStorData:
        """Create an instance of InsightsApiModelsResponsesGenerationDatasetRowsNonBmStorData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesGenerationDatasetRowsNonBmStorData.parse_obj(obj)

        _obj = InsightsApiModelsResponsesGenerationDatasetRowsNonBmStorData.parse_obj({
