...
class InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedDemand(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedDemand:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedDemand:
        """Create an instance of InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedDemand from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedDemand.parse_obj(obj)

        _obj = InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedDemand.parse_obj({
