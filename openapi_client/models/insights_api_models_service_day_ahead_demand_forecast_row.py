...
class InsightsApiModelsServiceDayAheadDemandForecastRow(BaseModel):
    """
    ...
    __properties = ["publishTime", "startTime", "settlementDate", "settlementPeriod", "boundary", "transmissionSystemDemand", "nationalDemand"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsServiceDayAheadDemandForecastRow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsServiceDayAheadDemandForecastRow:
        """Create an instance of InsightsApiModelsServiceDayAheadDemandForecastRow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightsApiModelsServiceDayAheadDemandForecastRow.parse_obj(obj)

        _obj = InsightsApiModelsServiceDayAheadDemandForecastRow.parse_obj({
