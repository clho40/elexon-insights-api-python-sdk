...
class InsightsApiModelsResponsesResponseWithMetadata1InsightsApiModelsResponsesTransparencyRemitRemitMessageWithId(BaseModel):
    """
    InsightsApiModelsResponsesResponseWithMetadata1InsightsApiModelsResponsesTransparencyRemitRemitMessageWithId
    """
    data: Optional[conlist(InsightsApiModelsResponsesTransparencyRemitRemitMessageWithId)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesResponseWithMetadata1InsightsApiModelsResponsesTransparencyRemitRemitMessageWithId:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesResponseWithMetadata1InsightsApiModelsResponsesTransparencyRemitRemitMessageWithId:
        ...
        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesResponseWithMetadata1InsightsApiModelsResponsesTransparencyRemitRemitMessageWithId.parse_obj(obj)

        _obj = InsightsApiModelsResponsesResponseWithMetadata1InsightsApiModelsResponsesTransparencyRemitRemitMessageWithId.parse_obj({
            "data": [InsightsApiModelsResponsesTransparencyRemitRemitMessageWithId.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
