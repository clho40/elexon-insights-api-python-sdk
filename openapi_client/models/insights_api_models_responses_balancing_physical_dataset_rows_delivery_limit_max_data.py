...
class InsightsApiModelsResponsesBalancingPhysicalDatasetRowsDeliveryLimitMaxData(BaseModel):
    """
    ...
    notification_time: Optional[datetime] = Field(None, alias="notificationTime")
    notification_sequence: Optional[StrictInt] = Field(None, alias="notificationSequence")
    ...
    __properties = ["dataset", "settlementDate", "settlementPeriod", "timeFrom", "timeTo", "levelFrom", "levelTo", "notificationTime", "notificationSequence", "nationalGridBmUnit", "bmUnit"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesBalancingPhysicalDatasetRowsDeliveryLimitMaxData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesBalancingPhysicalDatasetRowsDeliveryLimitMaxData:
        """Create an instance of InsightsApiModelsResponsesBalancingPhysicalDatasetRowsDeliveryLimitMaxData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesBalancingPhysicalDatasetRowsDeliveryLimitMaxData.parse_obj(obj)

        _obj = InsightsApiModelsResponsesBalancingPhysicalDatasetRowsDeliveryLimitMaxData.parse_obj({
            ...
            "notification_time": obj.get("notificationTime"),
            "notification_sequence": obj.get("notificationSequence"),
