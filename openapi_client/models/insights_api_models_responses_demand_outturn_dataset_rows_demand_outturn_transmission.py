...
class InsightsApiModelsResponsesDemandOutturnDatasetRowsDemandOutturnTransmission(BaseModel):
    """
    ...
    __properties = ["dataset", "publishTime", "startTime", "settlementDate", "settlementPeriod", "demand"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesDemandOutturnDatasetRowsDemandOutturnTransmission:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesDemandOutturnDatasetRowsDemandOutturnTransmission:
        """Create an instance of InsightsApiModelsResponsesDemandOutturnDatasetRowsDemandOutturnTransmission from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesDemandOutturnDatasetRowsDemandOutturnTransmission.parse_obj(obj)

        _obj = InsightsApiModelsResponsesDemandOutturnDatasetRowsDemandOutturnTransmission.parse_obj({
