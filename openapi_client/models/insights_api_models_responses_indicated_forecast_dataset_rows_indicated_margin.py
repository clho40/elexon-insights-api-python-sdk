...
class InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedMargin(BaseModel):
    """
    ...
    __properties = ["dataset", "margin", "publishTime", "startTime", "settlementDate", "settlementPeriod", "boundary"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedMargin:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedMargin:
        """Create an instance of InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedMargin from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedMargin.parse_obj(obj)

        _obj = InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedMargin.parse_obj({
