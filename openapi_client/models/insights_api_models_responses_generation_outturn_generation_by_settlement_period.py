...
class InsightsApiModelsResponsesGenerationOutturnGenerationBySettlementPeriod(BaseModel):
    """
    ...
    data: Optional[conlist(InsightsApiModelsResponsesGenerationOutturnGenerationValue)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesGenerationOutturnGenerationBySettlementPeriod:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesGenerationOutturnGenerationBySettlementPeriod:
        """Create an instance of InsightsApiModelsResponsesGenerationOutturnGenerationBySettlementPeriod from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesGenerationOutturnGenerationBySettlementPeriod.parse_obj(obj)

        _obj = InsightsApiModelsResponsesGenerationOutturnGenerationBySettlementPeriod.parse_obj({
            "start_time": obj.get("startTime"),
            "settlement_period": obj.get("settlementPeriod"),
            "data": [InsightsApiModelsResponsesGenerationOutturnGenerationValue.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
