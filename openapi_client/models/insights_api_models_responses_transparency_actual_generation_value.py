...
class InsightsApiModelsResponsesTransparencyActualGenerationValue(BaseModel):
    """
    ...
    __properties = ["businessType", "psrType", "quantity"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesTransparencyActualGenerationValue:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesTransparencyActualGenerationValue:
        """Create an instance of InsightsApiModelsResponsesTransparencyActualGenerationValue from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesTransparencyActualGenerationValue.parse_obj(obj)

        _obj = InsightsApiModelsResponsesTransparencyActualGenerationValue.parse_obj({
