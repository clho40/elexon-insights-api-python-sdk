...
class InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastTransmissionDayAhead(BaseModel):
    """
    ...
    __properties = ["dataset", "demand", "publishTime", "startTime", "settlementDate", "settlementPeriod", "boundary"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastTransmissionDayAhead:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastTransmissionDayAhead:
        ...
        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastTransmissionDayAhead.parse_obj(obj)

        _obj = InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastTransmissionDayAhead.parse_obj({
