...
class InsightsApiModelsResponsesBalancingPhysicalPhysicalData(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesBalancingPhysicalPhysicalData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesBalancingPhysicalPhysicalData:
        """Create an instance of InsightsApiModelsResponsesBalancingPhysicalPhysicalData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesBalancingPhysicalPhysicalData.parse_obj(obj)

        _obj = InsightsApiModelsResponsesBalancingPhysicalPhysicalData.parse_obj({
