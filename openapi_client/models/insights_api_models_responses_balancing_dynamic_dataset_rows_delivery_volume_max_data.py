...
class InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryVolumeMaxData(BaseModel):
    """
    ...
    volume_max: Optional[StrictInt] = Field(None, alias="volumeMax")
    ...
    __properties = ["dataset", "settlementDate", "settlementPeriod", "time", "volumeMax", "nationalGridBmUnit", "bmUnit"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryVolumeMaxData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryVolumeMaxData:
        """Create an instance of InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryVolumeMaxData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryVolumeMaxData.parse_obj(obj)

        _obj = InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryVolumeMaxData.parse_obj({
            "dataset": obj.get("dataset"),
            "settlement_date": obj.get("settlementDate"),
            "settlement_period": obj.get("settlementPeriod"),
            "time": obj.get("time"),
            "volume_max": obj.get("volumeMax"),
