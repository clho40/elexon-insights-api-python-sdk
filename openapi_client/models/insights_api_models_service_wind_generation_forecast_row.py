...
class InsightsApiModelsServiceWindGenerationForecastRow(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsServiceWindGenerationForecastRow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsServiceWindGenerationForecastRow:
        """Create an instance of InsightsApiModelsServiceWindGenerationForecastRow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightsApiModelsServiceWindGenerationForecastRow.parse_obj(obj)

        _obj = InsightsApiModelsServiceWindGenerationForecastRow.parse_obj({
