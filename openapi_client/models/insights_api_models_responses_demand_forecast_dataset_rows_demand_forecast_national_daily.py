...
class InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalDaily(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalDaily:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalDaily:
        """Create an instance of InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalDaily from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalDaily.parse_obj(obj)

        _obj = InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalDaily.parse_obj({
