...
class InsightsApiModelsResponsesBalancingDatasetRowsCreditDefaultNoticeDatasetResponse(BaseModel):
    """
    ...
    bsc_party_id: Optional[StrictStr] = Field(None, alias="bscPartyId")
    ...
    __properties = ["dataset", "publishTime", "bscPartyId", "creditDefaultLevel", "enteredDefaultSettlementDate", "enteredDefaultSettlementPeriod", "clearedDefaultSettlementDate", "clearedDefaultSettlementPeriod", "clearedDefaultText"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesBalancingDatasetRowsCreditDefaultNoticeDatasetResponse:
    ...
    def to_dict(self):
        ...
        # set to None if bsc_party_id (nullable) is None
        # and __fields_set__ contains the field
        if self.bsc_party_id is None and "bsc_party_id" in self.__fields_set__:
            _dict['bscPartyId'] = None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesBalancingDatasetRowsCreditDefaultNoticeDatasetResponse:
        """Create an instance of InsightsApiModelsResponsesBalancingDatasetRowsCreditDefaultNoticeDatasetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesBalancingDatasetRowsCreditDefaultNoticeDatasetResponse.parse_obj(obj)

        _obj = InsightsApiModelsResponsesBalancingDatasetRowsCreditDefaultNoticeDatasetResponse.parse_obj({
            "dataset": obj.get("dataset"),
            "publish_time": obj.get("publishTime"),
            "bsc_party_id": obj.get("bscPartyId"),
