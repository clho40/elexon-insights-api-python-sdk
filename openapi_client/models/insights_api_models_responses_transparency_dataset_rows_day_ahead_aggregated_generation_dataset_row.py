...
class InsightsApiModelsResponsesTransparencyDatasetRowsDayAheadAggregatedGenerationDatasetRow(BaseModel):
    """
    ...
    __properties = ["dataset", "documentId", "documentRevisionNumber", "publishTime", "quantity", "startTime", "settlementDate", "settlementPeriod"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesTransparencyDatasetRowsDayAheadAggregatedGenerationDatasetRow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesTransparencyDatasetRowsDayAheadAggregatedGenerationDatasetRow:
        ...
        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesTransparencyDatasetRowsDayAheadAggregatedGenerationDatasetRow.parse_obj(obj)

        _obj = InsightsApiModelsResponsesTransparencyDatasetRowsDayAheadAggregatedGenerationDatasetRow.parse_obj({
