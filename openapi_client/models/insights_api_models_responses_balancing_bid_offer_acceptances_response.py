...
class InsightsApiModelsResponsesBalancingBidOfferAcceptancesResponse(BaseModel):
    """
    ...
    __properties = ["settlementDate", "settlementPeriodFrom", "settlementPeriodTo", "timeFrom", "timeTo", "levelFrom", "levelTo", "nationalGridBmUnit", "bmUnit", "acceptanceNumber", "acceptanceTime", "deemedBoFlag", "soFlag", "storFlag", "rrFlag"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesBalancingBidOfferAcceptancesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesBalancingBidOfferAcceptancesResponse:
        """Create an instance of InsightsApiModelsResponsesBalancingBidOfferAcceptancesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesBalancingBidOfferAcceptancesResponse.parse_obj(obj)

        _obj = InsightsApiModelsResponsesBalancingBidOfferAcceptancesResponse.parse_obj({
