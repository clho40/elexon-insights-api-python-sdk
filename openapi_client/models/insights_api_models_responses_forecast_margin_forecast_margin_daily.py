...
class InsightsApiModelsResponsesForecastMarginForecastMarginDaily(BaseModel):
    """
    ...
    __properties = ["publishTime", "margin", "forecastDate"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesForecastMarginForecastMarginDaily:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesForecastMarginForecastMarginDaily:
        """Create an instance of InsightsApiModelsResponsesForecastMarginForecastMarginDaily from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesForecastMarginForecastMarginDaily.parse_obj(obj)

        _obj = InsightsApiModelsResponsesForecastMarginForecastMarginDaily.parse_obj({
