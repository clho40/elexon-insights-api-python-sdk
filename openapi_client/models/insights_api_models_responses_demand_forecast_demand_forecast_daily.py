...
class InsightsApiModelsResponsesDemandForecastDemandForecastDaily(BaseModel):
    """
    ...
    __properties = ["publishTime", "transmissionSystemDemand", "nationalDemand", "forecastDate"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesDemandForecastDemandForecastDaily:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesDemandForecastDemandForecastDaily:
        """Create an instance of InsightsApiModelsResponsesDemandForecastDemandForecastDaily from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesDemandForecastDemandForecastDaily.parse_obj(obj)

        _obj = InsightsApiModelsResponsesDemandForecastDemandForecastDaily.parse_obj({
