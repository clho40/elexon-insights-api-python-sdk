...
class InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedGeneration(BaseModel):
    """
    ...
    __properties = ["dataset", "generation", "publishTime", "startTime", "settlementDate", "settlementPeriod", "boundary"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedGeneration:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedGeneration:
        """Create an instance of InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedGeneration from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedGeneration.parse_obj(obj)

        _obj = InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedGeneration.parse_obj({
