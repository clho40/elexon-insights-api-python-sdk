...
class InsightsApiModelsResponsesTransparencyActualTotalLoadPerBiddingZone(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesTransparencyActualTotalLoadPerBiddingZone:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesTransparencyActualTotalLoadPerBiddingZone:
        """Create an instance of InsightsApiModelsResponsesTransparencyActualTotalLoadPerBiddingZone from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesTransparencyActualTotalLoadPerBiddingZone.parse_obj(obj)

        _obj = InsightsApiModelsResponsesTransparencyActualTotalLoadPerBiddingZone.parse_obj({
