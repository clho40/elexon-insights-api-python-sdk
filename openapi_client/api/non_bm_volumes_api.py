...
class NonBMVolumesApi:
    ...
    def balancing_nonbm_volumes_get(self, var_from : Annotated[datetime, Field(..., description="The \"from\" start time or settlement date for the filter.")], to : Annotated[datetime, Field(..., description="The \"to\" start time or settlement date for the filter.")], settlement_period_from : Annotated[Optional[StrictInt], Field(description="The \"from\" settlement period for the filter. This should be an integer from 1-50 inclusive.")] = None, settlement_period_to : Annotated[Optional[StrictInt], Field(description="The \"to\" settlement period for the filter. This should be an integer from 1-50 inclusive.")] = None, bm_unit : Annotated[Optional[conlist(StrictStr)], Field(description="The BM units to query. Add each unit separately. If no BM unit is selected all BM units will be displayed.")] = None, format : Annotated[Optional[StrictStr], Field(description="Response data format. Use json/xml to include metadata.")] = None, **kwargs) -> InsightsApiModelsResponsesResponseWithMetadata1InsightsApiModelsResponsesBalancingBalancingServicesVolume:  # noqa: E501
        ...
        >>> thread = api.balancing_nonbm_volumes_get(var_from, to, settlement_period_from, settlement_period_to, bm_unit, format, async_req=True)
        >>> result = thread.get()
        ...
        :rtype: InsightsApiModelsResponsesResponseWithMetadata1InsightsApiModelsResponsesBalancingBalancingServicesVolume
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the balancing_nonbm_volumes_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.balancing_nonbm_volumes_get_with_http_info(var_from, to, settlement_period_from, settlement_period_to, bm_unit, format, **kwargs)  # noqa: E501

    @validate_arguments
    def balancing_nonbm_volumes_get_with_http_info(self, var_from : Annotated[datetime, Field(..., description="The \"from\" start time or settlement date for the filter.")], to : Annotated[datetime, Field(..., description="The \"to\" start time or settlement date for the filter.")], settlement_period_from : Annotated[Optional[StrictInt], Field(description="The \"from\" settlement period for the filter. This should be an integer from 1-50 inclusive.")] = None, settlement_period_to : Annotated[Optional[StrictInt], Field(description="The \"to\" settlement period for the filter. This should be an integer from 1-50 inclusive.")] = None, bm_unit : Annotated[Optional[conlist(StrictStr)], Field(description="The BM units to query. Add each unit separately. If no BM unit is selected all BM units will be displayed.")] = None, format : Annotated[Optional[StrictStr], Field(description="Response data format. Use json/xml to include metadata.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Balancing Services Volume  # noqa: E501
        ...
        >>> thread = api.balancing_nonbm_volumes_get_with_http_info(var_from, to, settlement_period_from, settlement_period_to, bm_unit, format, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(InsightsApiModelsResponsesResponseWithMetadata1InsightsApiModelsResponsesBalancingBalancingServicesVolume, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method balancing_nonbm_volumes_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "InsightsApiModelsResponsesResponseWithMetadata1InsightsApiModelsResponsesBalancingBalancingServicesVolume",
            '400': None,
            '500': None,
        }
