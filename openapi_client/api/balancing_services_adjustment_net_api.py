...
class BalancingServicesAdjustmentNetApi:
    ...
    def balancing_nonbm_netbsad_events_get(self, count : Annotated[StrictInt, Field(..., description="The number of events to return.")], before : Annotated[Optional[datetime], Field(description="If specified, filters events to those with a start time before or at the date, or a settlement date before the date if  settlementPeriodBefore is also specified.  If omitted, latest events are returned.")] = None, settlement_period_before : Annotated[Optional[StrictInt], Field(description="Filters events to those with a settlement period before or at the value.  Before parameter must be specified if this is specified.")] = None, format : Annotated[Optional[StrictStr], Field(description="Response data format. Use json/xml to include metadata.")] = None, **kwargs) -> InsightsApiModelsResponsesResponseWithMetadata1InsightsApiModelsResponsesBalancingNetBalancingServicesAdjustmentResponse:  # noqa: E501
        ...
        >>> thread = api.balancing_nonbm_netbsad_events_get(count, before, settlement_period_before, format, async_req=True)
        >>> result = thread.get()
        ...
        :rtype: InsightsApiModelsResponsesResponseWithMetadata1InsightsApiModelsResponsesBalancingNetBalancingServicesAdjustmentResponse
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the balancing_nonbm_netbsad_events_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.balancing_nonbm_netbsad_events_get_with_http_info(count, before, settlement_period_before, format, **kwargs)  # noqa: E501

    @validate_arguments
    def balancing_nonbm_netbsad_events_get_with_http_info(self, count : Annotated[StrictInt, Field(..., description="The number of events to return.")], before : Annotated[Optional[datetime], Field(description="If specified, filters events to those with a start time before or at the date, or a settlement date before the date if  settlementPeriodBefore is also specified.  If omitted, latest events are returned.")] = None, settlement_period_before : Annotated[Optional[StrictInt], Field(description="Filters events to those with a settlement period before or at the value.  Before parameter must be specified if this is specified.")] = None, format : Annotated[Optional[StrictStr], Field(description="Response data format. Use json/xml to include metadata.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Net Balancing Services Adjustment (NETBSAD) events  # noqa: E501
        ...
        >>> thread = api.balancing_nonbm_netbsad_events_get_with_http_info(count, before, settlement_period_before, format, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(InsightsApiModelsResponsesResponseWithMetadata1InsightsApiModelsResponsesBalancingNetBalancingServicesAdjustmentResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method balancing_nonbm_netbsad_events_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "InsightsApiModelsResponsesResponseWithMetadata1InsightsApiModelsResponsesBalancingNetBalancingServicesAdjustmentResponse",
            '400': None,
            '500': None,
        }
    ...
    def balancing_nonbm_netbsad_get(self, var_from : Annotated[datetime, Field(..., description="The \"from\" start time or settlement date for the filter.")], to : Annotated[datetime, Field(..., description="The \"to\" start time or settlement date for the filter.")], settlement_period_from : Annotated[Optional[StrictInt], Field(description="The \"from\" settlement period for the filter. This should be an integer from 1-50 inclusive.")] = None, settlement_period_to : Annotated[Optional[StrictInt], Field(description="The \"to\" settlement period for the filter. This should be an integer from 1-50 inclusive.")] = None, include_zero : Annotated[Optional[StrictBool], Field(description="Include data points with a generation of zero.")] = None, format : Annotated[Optional[StrictStr], Field(description="Response data format. Use json/xml to include metadata.")] = None, **kwargs) -> InsightsApiModelsResponsesResponseWithMetadata1InsightsApiModelsResponsesBalancingNetBalancingServicesAdjustmentResponse:  # noqa: E501
        ...
        >>> thread = api.balancing_nonbm_netbsad_get(var_from, to, settlement_period_from, settlement_period_to, include_zero, format, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the balancing_nonbm_netbsad_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.balancing_nonbm_netbsad_get_with_http_info(var_from, to, settlement_period_from, settlement_period_to, include_zero, format, **kwargs)  # noqa: E501

    @validate_arguments
    def balancing_nonbm_netbsad_get_with_http_info(self, var_from : Annotated[datetime, Field(..., description="The \"from\" start time or settlement date for the filter.")], to : Annotated[datetime, Field(..., description="The \"to\" start time or settlement date for the filter.")], settlement_period_from : Annotated[Optional[StrictInt], Field(description="The \"from\" settlement period for the filter. This should be an integer from 1-50 inclusive.")] = None, settlement_period_to : Annotated[Optional[StrictInt], Field(description="The \"to\" settlement period for the filter. This should be an integer from 1-50 inclusive.")] = None, include_zero : Annotated[Optional[StrictBool], Field(description="Include data points with a generation of zero.")] = None, format : Annotated[Optional[StrictStr], Field(description="Response data format. Use json/xml to include metadata.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Net Balancing Services Adjustment (NETBSAD) time series  # noqa: E501
        ...
        >>> thread = api.balancing_nonbm_netbsad_get_with_http_info(var_from, to, settlement_period_from, settlement_period_to, include_zero, format, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method balancing_nonbm_netbsad_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
