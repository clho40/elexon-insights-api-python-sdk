...
class InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalDayAhead(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalDayAhead:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalDayAhead:
        """Create an instance of InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalDayAhead from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalDayAhead.parse_obj(obj)

        _obj = InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalDayAhead.parse_obj({
